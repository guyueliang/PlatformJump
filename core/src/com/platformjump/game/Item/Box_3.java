...
public class Box_3 extends BaseGameActor {
    ...
    private float maxShowTime = 0.15f;
    private float timeCounter = 0.0f;

    public final Box_3.Box_3_CollisionFilter BOX_3_COLLISION_FILTER = new Box_3.Box_3_CollisionFilter();


    public Box_3(float x, float y, BaseGameStage s) {
        super(x, y, s);

        Idle = loadTexture("Boxes/Box3/Idle.png");
        Hit = loadAnimationFromSheet("Boxes/Box3/Hit.png",1,2,0.08f,true);
    ...
    public void act(float delta) {
        ...
        if(flag) {
            Response.Result result = baseGameStage.getMainGame().getWorld().move(item, getX() + bboxX, getY() + bboxY, BOX_3_COLLISION_FILTER);
    ...
    private  class Box_3_CollisionFilter implements CollisionFilter {
        @Override
